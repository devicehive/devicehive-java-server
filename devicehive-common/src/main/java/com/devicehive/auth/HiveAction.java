...
public enum HiveAction {
    ...
    GET_DEVICE_TYPE(16, Constants.GET_DEVICE_TYPE),
    MANAGE_DEVICE_TYPE(17, Constants.MANAGE_DEVICE_TYPE);

    private static Set<HiveAction> CLIENT_ACTIONS = ImmutableSet.of(GET_NETWORK, GET_DEVICE_TYPE, GET_DEVICE,
            GET_DEVICE_NOTIFICATION, GET_DEVICE_COMMAND, REGISTER_DEVICE, CREATE_DEVICE_NOTIFICATION,
            CREATE_DEVICE_COMMAND, UPDATE_DEVICE_COMMAND, GET_CURRENT_USER, UPDATE_CURRENT_USER,MANAGE_TOKEN);

    private static Set<HiveAction> ADMIN_ACTIONS = ImmutableSet.of(MANAGE_USER, MANAGE_CONFIGURATION, MANAGE_NETWORK, MANAGE_DEVICE_TYPE);
