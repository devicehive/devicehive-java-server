...
/**
 * Client side controller for network: <i>/network</i>
 * See <a href="http://www.devicehive.com/restful/#Reference/Network">DeviceHive RESTful API: Network</a> for
 * details.
...
public interface NetworkController {
    ...
    /**
     * Queries list of networks using following criteria:
     * See: <a href="http://www.devicehive.com/restful#Reference/Network/list">DeviceHive RESTful
     * API: Network: list</a> for more details.
     *
     ...
     * See: <a href="http://www.devicehive.com/restful#Reference/Network/get">DeviceHive RESTful
     * API: Network: get</a> for more details.
     *
    ...
    /**
     * Creates new network.
     * See: <a href="http://www.devicehive.com/restful#Reference/Network/insert">DeviceHive RESTful
     ...
     * See: <a href="http://www.devicehive.com/restful#Reference/Network/delete">DeviceHive RESTful
     * API: Network: delete</a> for more details.
     *
     * @param id network identifier
     */
