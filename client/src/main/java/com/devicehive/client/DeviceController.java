...
public interface DeviceController {
    ...
    /**
     * Queries list of all available devices according to the specified parameters.
     * See <a href="http://www.devicehive.com/restful#Reference/Device/list"> DeviceHive RESTful API:
     * Device: list</a> for more details.
     *
     ...
     * @param sortField          Result list sort field. Available values are "Name", "Status",
     *                           "Network" and "DeviceClass".
     ...
     * See <a href="http://www.devicehive.com/restful#Reference/Device/get">DeviceHive RESTful
     * API: Device: get</a> for more details.
     *
     ...
     * it gets to be updated in case when valid key is provided in the authorization header.
     * See <a href="http://www.devicehive.com/restful#Reference/Device/register">DeviceHive RESTful
     * API: Device: register</a> for more details.
     *
     ...
     * See <a href="http://www.devicehive.com/restful#Reference/Device/delete">DeviceHive RESTful
     * API: Device: delete</a>  for more details.
     *
     * @param deviceId Device unique identifier
     */
     ...
     * See <a href="http://www.devicehive.com/restful#Reference/Device/equipment">DeviceHive RESTful
     ...
     * See <a href="http://www.devicehive.com/restful#Reference/DeviceClass/list">DeviceHive RESTful API:
     * DeviceClass: list</a> for more details
     *
     ...
     * See <a href="http://www.devicehive.com/restful#Reference/DeviceClass/insert">DeviceHive RESTful
     * API: DeviceClass: insert</a> for more details.
     *
     ...
     * See <a href="http://www.devicehive.com/restful#Reference/DeviceClass/delete">DeviceHive RESTful
     * API: DeviceClass: delete</a> for more details.
     *
     * @param classId device class identifier
     */
