...
class DeviceControllerImpl implements DeviceController {
    ...
    public List<Device> listDevices(String name, String namePattern, String status, Integer networkId,
        ...
        String path = "/device";
        List<Device> result = hiveContext.getRestConnector().execute(path, HttpMethod.GET, null, queryParams,
    ...
    public Device getDevice(String deviceId) throws HiveException {
        ...
        Device result = hiveContext.getRestConnector().execute(path, HttpMethod.GET, null, Device.class,
                DEVICE_PUBLISHED);
    ...
    public void registerDevice(String deviceId, Device device) throws HiveException {
        ...
        String path = "/device/" + deviceId;
        hiveContext.getRestConnector().execute(path, HttpMethod.PUT, null, device, DEVICE_PUBLISHED);
    ...
    public void deleteDevice(String deviceId) throws HiveException {
        ...
        String path = "/device/" + deviceId;
        hiveContext.getRestConnector().execute(path, HttpMethod.DELETE);
    ...
    public List<DeviceClass> listDeviceClass(String name, String namePattern, String version, String sortField,
        ...
        queryParams.put("take", take);
        queryParams.put("skip", skip);
        List<DeviceClass> result = hiveContext.getRestConnector().execute(path, HttpMethod.GET, null, queryParams,
    ...
    public long insertDeviceClass(DeviceClass deviceClass) throws HiveException {
        ...
        String path = "/device/class";
        DeviceClass inserted = hiveContext.getRestConnector().execute(path, HttpMethod.POST, null, null, deviceClass,
    ...
    public void updateDeviceClass(long classId, DeviceClass deviceClass) throws HiveException {
        ...
        String path = "/device/class/" + classId;
        hiveContext.getRestConnector().execute(path, HttpMethod.PUT, null, deviceClass, DEVICECLASS_PUBLISHED);
