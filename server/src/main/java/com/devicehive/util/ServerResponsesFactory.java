...
public class ServerResponsesFactory {
    ...
    public static String parseNotificationStatus(DeviceNotificationMessage notificationMessage) {
        String jsonParametersString = notificationMessage.getParameters().getAsString();
