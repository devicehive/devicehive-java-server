...
import com.devicehive.application.DeviceHivePluginApplication;
...
@SpringBootTest(classes = {DeviceHivePluginApplication.class}, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
@DirtiesContext
