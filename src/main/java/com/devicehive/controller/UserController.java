...
public class UserController {
    ...
    public Response insertUser(UserInsert user) {
        ...
        User existing = userDAO.findByLogin(user.getLogin().getValue());
    ...
    public Response updateUser(UserInsert user, @PathParam("id") long userId) {
        ...
        if (user.getLogin() != null) {
            User u = userDAO.findByLogin(user.getLogin().getValue());
    ...
    public Response getCurrent() {
        ...
        Annotation[] annotations = {new JsonPolicyApply.JsonPolicyApplyLiteral(JsonPolicyDef.Policy.USER_PUBLISHED)};
        User currentUser = userDAO.findUserWithNetworksByLogin(login);
        return Response.ok().entity(currentUser, annotations).build();
    }
